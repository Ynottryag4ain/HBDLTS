...
const LETTER_PARAGRAPHS = [
  "ถึงคนที่ฉันรักที่สุดในโลก... 💕",
  "วันนี้เป็นวันพิเศษมากๆ เพราะเธอเกิดมาในโลกนี้ ทุกวันที่ได้อยู่ข้างๆ เธอทำให้ชีวิตฉันสมบูรณ์และมีความหมายมากขึ้น",
  "เธอทำให้ฉันรู้ว่าความรักที่แท้จริงนั้นสวยงามแค่ไหน ขอบคุณที่เป็นเธอ ขอบคุณที่รักฉัน และขอบคุณที่อยู่ข้างๆ ฉันเสมอ 🌸",
  "ขอให้วันเกิดปีนี้เต็มไปด้วยความสุข รอยยิ้ม และทุกสิ่งที่เธอปรารถนา Happy Birthday นะที่รัก ❤️",
]
